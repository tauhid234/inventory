...
if(!isset($_SESSION["username"])){
  header("Location:../../../pages/login.php");
    ...
    if(isset($_GET['inv']) && isset($_GET['no_inv'])){
        $versi = $_GET['inv'];
        $no_inv = $_GET['no_inv'];
        $data = $model->ViewIdPurchaseInvoice($versi, $no_inv);
...
<html>
<head>
<title>BINTANG 89 - INVOICE PEMBELIAN</title>
...
<span style="font-size: 15px; font-weight: bold;">INVOICE PEMBELIAN <?= $data[0]['no_invoice_purchase']; ?></span>  </br>
</td>
<td style='vertical-align:middle' width='30%' align='right'>
<b><span style='font-size:8pt'>Tanggal <?= $data[0]['purchase_date']; ?></span></b></br>
<b>Suplier : <?= $data[0]['name_suplier']; ?></b> </br>
<b><?= $data[0]['alamat_suplier']; ?></b> </br>
<b><?= $data[0]['no_handphone_suplier']; ?></b> </br>
</td>
</table>
...
<td width='20%' style="font-weight: bold; border-bottom: 1px solid black; border-top: 1px solid black; border-left: 1px solid black;">Nama Barang Pembelian</td>
...
<tr>
    ...
    <td style="font-weight: bold; text-align: center" class="qty"><?= $d['purchase_amount']; ?></td>
    <td style="font-weight: bold; text-align: center" class="qty"><?= $d['unit_type']; ?></td>
    <td style="font-weight: bold; text-align: center;" class="qty"><?= $d['purchase_price']; ?> </td>
...
<td align='center'></br></br></br>Suplier</br>
<!-- </br><u>(.....................................................)</u></td> -->
</tr>
</table>
</center>
