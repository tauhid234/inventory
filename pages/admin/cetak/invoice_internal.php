...
if(!isset($_SESSION["username"])){
  header("Location:../../../pages/login.php");
    ...
    if(isset($_GET['inv'])){
        ...
        $num = 0;
        $total_untung_sales = 0;
        foreach($data as $r){
            $num += (int)$r['total_amount'];
            $total_untung_sales += (int) $r['price_clean'] * $r['selling_amount'];
        }
    }
?>
...
<html>
<head>
<title>BINTANG 89 - INVOICE INTERNAL</title>
...
<td width='13%' style="font-weight: bold; border-bottom: 1px solid black; border-top: 1px solid black;">Total Harga</td>
<td width='13%' style="font-weight: bold; border-bottom: 1px solid black; border-top: 1px solid black; border-right: 1px solid black;">Total Keuntungan</td>
</tr>
...
<tr>
    ...
    <td style="font-weight: bold; text-align: center;" class="qty"><?= number_format($d['price_sales'], 0, '', ','); ?> </td>
    <td style="font-weight: bold; text-align: center;" class="qty"><?= number_format($d['total_amount'], 0, '', ','); ?> </td>
    <td style="font-weight: bold; text-align: right; border-right: 1px solid black;" class="qty"><?= number_format((int) $d['price_clean'] * $d['selling_amount']); ?> </td>
</tr>
<?php } ?>
...
<td style='text-align:center; border-bottom: 1px solid black; border-top: 1px solid black; solid black;'><b><?= number_format($num , 0, '', ','); ?></b></td>
<td style='text-align:right; border-bottom: 1px solid black; border-top: 1px solid black; border-right: 1px solid black; solid black;'><b><?= number_format($total_untung_sales, 0, '', ','); ?></b></td>
</table>
...
<td align='center'></br></br></br>Sales</br>
<!-- </br><u>(.....................................................)</u></td> -->
</tr>
</table>
</center>
